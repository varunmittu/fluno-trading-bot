...
df_h = prep(get_yf("60m", start="2024-12-01", end="2026-04-11"))
...
capital, lots = simulate(df_h, date(2025, 1, 1), date(2026, 4, 9),  capital, lots, trades, day_net)
capital, lots = simulate(df_5, date(2026, 4, 10), date(2026, 7, 3), capital, lots, trades, day_net)

print("\n" + "=" * 74)
print("18-MONTH PRACTICE RUN 1 Jan 2025 -> 3 Jul 2026 | CURRENT LIVE SETTINGS")
print("Jan2025-Apr2026: HOURLY data (approx) | May-Jul2026: 5-min (exact)")
print("=" * 74)
